...
PICS = (environ.get('PICS', 'https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg https://graph.org/file/75496bc54da062159a103.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'kanhaDeveloper')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Sonic kuwal update™](https://t.me/Sonickuwalupdate)</b>⚡\n\n🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>KANHAIYA LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Sonic kuwal update™](https://t.me/Sonickuwalupdate)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @kanhaDeveloper \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
URL = "https://kanhamovielazyprincess-sonickuwalmovie.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kanhamovielazyprincess-sonickuwalmovie.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kanhamovielazyprincess-sonickuwalmovie.koyeb.app/".format(FQDN)
else:
    URL = "https://kanhamovielazyprincess-sonickuwalmovie.koyeb.app/".format(FQDN)
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002055174802")).split())) 
OWNER_USERNAME = "KanhaDeveloper"
...
DOWNLOAD_TEXT_URL = "https://t.me/Sonickuwalupdate/48"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Sonickuwalupdate"
...
LOG_STR += f"Your current IMDB template is {IMDB_TEMPLATE}"# Credit @KANHADeveloper.
